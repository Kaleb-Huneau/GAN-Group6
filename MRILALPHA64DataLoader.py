...
with tf.device('/cpu:0'):  
    ...
    class AlphaGAN(object):
        ...
        def get_data(self):
            ...
            if self.dataset == 'mri':
                ...
                tumor_dir = '/home/user4/Desktop/AlphaGANMRI/cleaned7/Training/notumor'
                ...
                tumor_dir = '/home/user4/Desktop/AlphaGANMRI/cleaned7/Testing/notumor'
                ...
                training_dir_data_loader = '/home/user4/Desktop/AlphaGANMRI/cleaned7/Training/alltumors'
                testing_dir_data_loader = '/home/user4/Desktop/AlphaGANMRI/cleaned7/Testing/notumor'
    ...
    opts = Option(gan_type='alpha', alpha=3.0, seed=42, c_type='discrete', n_epochs=250, dataset='mri', loss_type='vanilla', lambda_d=1.0, lambda_c=0.1, num_images= 60, gp=False, gen_lr=0.0002, dis_lr=0.0002, q_lr=0.0002, gp_coef=5.0, alpha_d=2.99, alpha_g=3.0, k=2.0, shifted=False, l1=False) #alpha_d < 1 is good
